...
var e,
  ...
  m = t(require('@bscswap/contracts/build/IBSCswapPair.json'))
;((n = exports.ChainId || (exports.ChainId = {}))[(n.MAINNET = 1)] = 'MAINNET'),
  (n[(n.ROPSTEN = 3)] = 'ROPSTEN'),
  (n[(n.RINKEBY = 4)] = 'RINKEBY'),
  (n[(n['GÖRLI'] = 5)] = 'GÖRLI'),
  (n[(n.KOVAN = 42)] = 'KOVAN'),
  (n[(n.BSC_MAINNET = 56)] = 'BSC_MAINNET'),
  (n[(n.BSC_TESTNET = 97)] = 'BSC_TESTNET'),
...
var v,
  y = '0x3a209ed9225acf3fa0e330117d94856748d49ae810a51d42c36496e9a62cd07c',
  w = i.BigInt(1e3),
  T = i.BigInt(0),
  g = i.BigInt(1),
  k = i.BigInt(2),
  ...
  H = (function(t) {
    function e() {
      ...
      return (
        ...
        W && Object.setPrototypeOf(F(n), (this instanceof e ? this.constructor : void 0).prototype),
        n
      )
    }
    return P(e, t), e
...
var tt,
  ...
  nt =
    ...
    (J[exports.ChainId.BSC_MAINNET] = new z(
    ...
    (J[exports.ChainId.BSC_TESTNET] = new z(
  ...
  lt = (function() {
          ...
          (ft = B(
            ...
            (((u = {})[s[0].address] = B(
              ...
              (((i = {})[s[1].address] = a.getCreate2Address(
                '0x3C60E7647D1972eF56a81Fd618b65E6A3e6bF799',
    ...
    return (
      ...
      (e.getInputAmount = function(e) {
        ...
        var n = this.reserveOf(e.token),
          r = this.reserveOf(e.token.equals(this.token0) ? this.token1 : this.token0),
          o = i.multiply(i.multiply(r.raw, e.raw), N),
      ...
      (e.getLiquidityMinted = function(t, e, n) {
        ...
        if (((o[0].token.equals(this.token0) && o[1].token.equals(this.token1)) || u(!1), i.equal(t.raw, T)))
          r = i.subtract(V(i.multiply(o[0].raw, o[1].raw)), w)
        else {
    ...
    function t(t, e, n) {
      t.length > 0 || u(!1),
        ...
        void 0 === n ||
          ...
          u(!1)
      for (var r, o = [e instanceof z ? e : nt[t[0].chainId]], i = M(t.entries()); !(r = i()).done; ) {
        var a = r.value,
          s = a[1],
          c = o[a[0]]
      ...
      (t.swapCallParameters = function(t, e) {
        ...
        switch (t.tradeType) {
          case exports.TradeType.EXACT_INPUT:
            n
              ? ((o = l ? 'swapExactBNBForTokensSupportingFeeOnTransferTokens' : 'swapExactBNBForTokens'),
                (i = [d, p, s, f]),
                (a = c))
              : r
              ? ((o = l ? 'swapExactTokensForBNBSupportingFeeOnTransferTokens' : 'swapExactTokensForBNB'),
                (i = [c, d, p, s, f]),
                (a = '0x0'))
          ...
          case exports.TradeType.EXACT_OUTPUT:
            l && u(!1),
              n
                ? ((o = 'swapBNBForExactTokens'), (i = [d, p, s, f]), (a = c))
                : r
                ? ((o = 'swapTokensForExactBNB'), (i = [d, c, p, s, f]), (a = '0x0'))
...
;(exports.JSBI = i),
  ...
  (exports.ETHER = $),
  (exports.FACTORY_ADDRESS = '0x3C60E7647D1972eF56a81Fd618b65E6A3e6bF799'),
  (exports.Fetcher = Nt),
  (exports.Fraction = at),
  (exports.INIT_CODE_HASH = y),
  (exports.InsufficientInputAmountError = L),
  (exports.InsufficientReservesError = H),
