...
export default function Idopools() {
  ...
  const setListData = useCallback(async () => {
    ...
    // const predicate = (apy: ApyRaw) => LIST.map((v) => ({pid: v.Pid, ip: v.lpAddress}))?.includes({pid: apy.Pid, ip: apy.lpAddress});
    setApyListState(LIST);
  }, [apyList]);
      ...
      <div className="col-lg-4 col-md-4 col-sm-12" key={index}>
        <div className="card centered farm-card">
          ...
          <div className="grid-item-content" id="DIV_1">
            ...
            <StakingActions farm={item.lpAddress} pid={item.Pid} deposit={item.Deposit} lockedPeriod={item.lockedPeriod} />
          </div>
  ...
  return (
    <>
      <SeoHelmet title="Ninja IDO Pools" />
      <div className="main container" id="">
        ...
        >
          <div className="col-lg-10">
            ...
            <h1 className="subTitle"> Stake Ninja for EIDOs whitelist</h1>
