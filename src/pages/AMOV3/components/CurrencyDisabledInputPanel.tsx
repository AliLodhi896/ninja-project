import { Currency, Token, Pair } from '@bscswap/sdk';
...
export default function CurrencyDisabledInputPanel({
  value,
  onUserInput,
  label = 'Input',
  ...
  return (
    <InputPanel id={id}>
      ...
      >
        <Centeral>
          {currency ? <StyledLogo size={'24px'} srcs={[currency?.logo]} alt={'token'} /> : null}
          <StyledTokenName
