...
/*
* Volterra Token Contract
*/
contract XNinjaSwap is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "XNinjaSwap";
    string constant _symbol = "XNINJA";
    uint8 constant _decimals = 18;

    uint256 _totalSupply = 7600000* (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 100;  //Max 1% transfer of supply ,																	
